...
layout = html.Div([
    ...
    html.Div([
        html.Div([
            ...
            html.Label('Inactive Batches'), dcc.Input(id='inactive-batches', value=5, type='number'),
            html.Label('Particles'), dcc.Input(id='particles', value=7500, type='number'),
            ...
            html.Label('Trigger Batch Interval'), dcc.Input(id='trigger-batch-interval', value=None, type='number'),
            html.Label('Trigger Max Batches'), dcc.Input(id='trigger-max-batches', value=None, type='number'),
...
@app.callback(
    ...
    [State('total-batches', 'value'),
     ...
     State('trigger-batch-interval', 'value'),
     State('trigger-max-batches', 'value'),
     # ...
...
def store_settings(click,
                   ...
                   trigger_active, trigger_batch_interval, trigger_max_batches,
    ...
    if click:
        settings_data.update({'total-batches': total_batches,
                              ...
                              'trigger-batch-interval': trigger_batch_interval,
                              'trigger-max-batches': trigger_max_batches,
                              'no-reduce': no_reduce,
